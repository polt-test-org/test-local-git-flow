...
def main(host: str, port: int):
    skill = AgentSkill(
        id="collection-email-agent",
        name="collection-email-agent",
        description="An AI agent that drafts personalized collection emails based on S/4HANA dunning data and outstanding invoices",
        tags=["collection", "email", "agent", "accounts-receivable", "dunning"],
        examples=["Draft collection email for BusinessPartner BP001", "Generate overdue payment reminder for customer 0000100023"],
    )
